<h1 align="center">Hola, soy Andrés González. <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"></h1>
<p align="center">
...
- :school: Soy aprendiz de **Análisis y Desarrollo de Software** en el [SENA](https://www.sena.edu.co/)
- :trophy: Me apasiona el desarrollo **Backend** con Java y Spring Boot
- :technologist: Trabajo con bases de datos **NoSQL** usando MongoDB
- :computer: Aprendo sobre **seguridad** en APIs REST con Spring Security y JWT
- :student: Actualmente aprendiendo **Arquitectura por capas** e **Ingeniería de Software**
- :nerd_face:**aprendiendo cosas nuevas**
- :thinking: Construyo APIs limpias, bien estructuradas y escalables
- :boom: Abierto a nuevas **oportunidades y proyectos**
<br>
